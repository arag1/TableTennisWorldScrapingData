...
driver.get('http://results.ittf.link/index.php?option=com_fabrik&view=list&listid=69&Itemid=206')
    ...
    while attempts < 2:
        try:
            python_button = driver.find_element_by_xpath(
                '//*[@id="list_69_com_fabrik_69"]/tfoot/tr/td/div/div/div[2]/ul/li[13]/a')
            if counter == 0:
...
dataset.to_csv("ProfessionalTableTennisMenWorldRankingsExperiment.csv", index = False)